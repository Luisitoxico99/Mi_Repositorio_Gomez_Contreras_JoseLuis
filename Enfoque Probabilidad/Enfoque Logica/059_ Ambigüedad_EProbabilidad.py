...
# Ejemplo de uso
cadena_ambigua = "2 + 3 * 4"
analizador_ambiguo = AnalizadorSintactico(cadena_ambigua)
arbol_sintaxis_ambiguo = analizador_ambiguo.analizar()
print("Árbol de sintaxis para la cadena ambigua:", arbol_sintaxis_ambiguo)

cadena_no_ambigua = "2 + (3 * 4)"
analizador_no_ambiguo = AnalizadorSintactico(cadena_no_ambigua)
arbol_sintaxis_no_ambiguo = analizador_no_ambiguo.analizar()
print("Árbol de sintaxis para la cadena no ambigua:", arbol_sintaxis_no_ambiguo)
