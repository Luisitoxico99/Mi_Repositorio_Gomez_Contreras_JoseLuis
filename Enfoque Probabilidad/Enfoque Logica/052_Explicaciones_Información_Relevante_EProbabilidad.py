...
def generar_regla(ejemplos_positivos, ejemplos_negativos, caracteristicas):
    ...
    for caracteristica in caracteristicas:
        ...
        # Verificar si todos los ejemplos positivos tienen el mismo valor para esta característica
        if len(positivos_para_caracteristica) == len(ejemplos_positivos):
            # Si todos los ejemplos positivos tienen el mismo valor para esta característica,
        ...
        # Verificar si todos los ejemplos negativos tienen el mismo valor para esta característica
        if len(negativos_para_caracteristica) == len(ejemplos_negativos):
            # Si todos los ejemplos negativos tienen el mismo valor para esta característica,
